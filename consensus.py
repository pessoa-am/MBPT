...
def parse_args():
	parser = argparse.ArgumentParser(description="Generate a consensus sequence from a FASTA file")
	parser.add_argument("input_file", metavar="FASTA_FILE", help="Input FASTA file")
