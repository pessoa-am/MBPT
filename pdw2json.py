...
def parse_args():
	parser = argparse.ArgumentParser(description="Converts a pDRAW32 file into JSON")
	parser.add_argument("input_file", metavar="PDW_FILE", help="Input pDRAW32 file (*.pdw)")
	parser.add_argument("-o", metavar="OUTPUT_FILE", help="Output JSON to file instead of stdout")
